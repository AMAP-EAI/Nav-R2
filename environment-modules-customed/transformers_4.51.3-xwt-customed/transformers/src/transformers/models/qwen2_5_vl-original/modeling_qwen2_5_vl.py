...
class Qwen2_5_VLModel(Qwen2_5_VLPreTrainedModel):
    ...
    def compress_historical_image_features(self, image_embeds, image_grid_thw, merge_size, historical_image_feature_list=None):
        """
        bnd
        """
        ...
        # pooling
        pooled_embeds_list = [self.historical_image_feature_pooling_layer_of_each_image(embeds.permute(1,0)).permute(1,0) for embeds in image_embeds_list]    # [n, d] for each image

        # stack
        return torch.stack(pooled_embeds_list, dim=0).flatten(0,1)  # [b, n, d]


    def compress_current_image_feature(self, current_image_feature): # model.model.compress_current_image_feature
        return self.current_image_feature_pooling_layer(current_image_feature.permute(1,0)).permute(1,0)
